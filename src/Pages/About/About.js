...
const About = () => {
    ...
    return (
        <div className='container pt-5 pb-5'>
            <div className="row">
                <div className="col-md-3 border-top border-5 border-info  position-relative ">
                    <div className='d-flex flex-column position-sticky top-0'>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus1">What is art?</a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus2">History of painting </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus3">Why painting is important?</a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus4">#1 Paintings increase cultural appreciation</a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus5">#2 Paintings help people learn history</a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus6">#3 Painting boosts creativity</a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus7"> #4 Painting can improve your focus </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus8"> #5 Painting can improve problem-solving skills </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus9"> #6 Painting helps you communicate emotions </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus10"> #7 Painting can improve self-esteem </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus11"> #8 Looking at paintings increases blood flow to the brain </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus12"> #9 Painting can improve mental health </a>
                        <a className='text-decoration-none text-dark p-2 border-bottom' href="#qus13"> #10 Painting can improve health in your older years </a>
                    </div>
                </div>
                <div className="col-md-9">
                    <h5 id='qus1'>What is art?</h5>
                    <p>
                    ...
                    <h5 id='qus2'>History of painting : </h5>
                    <p>
                    ...
                    <h5 id='qus3'>Why painting is important?</h5>
                    <p>
                        ...
                        Consequently, Vones depicts why is art important to our society?
                    ...
                    <br />
                    <p><b>Here is the more rezone</b></p>
                    <p id='qus4'>
                        <b>#1 Paintings increase cultural appreciation</b><br />
                    ...
                    <p id='qus5'>
                        <b> #2 Paintings help people learn history</b><br />
                    ...
                    <p id='qus6'>
                        <b> #3 Painting boosts creativity </b><br />
                    ...
                    <p id='qus7'>
                        <b> #4 Painting can improve your focus </b><br />
                    ...
                    <p id='qus8'>
                        <b> #5 Painting can improve problem-solving skills </b><br />
                    ...
                    <p id='qus9'>
                        <b> #6 Painting helps you communicate emotions</b><br />
                    ...
                    <p id='qus10'>
                        <b>#7 Painting can improve self-esteem</b><br />
                    ...
                    <p id='qus11'>
                        <b>#8 Looking at paintings increases blood flow to the brain</b><br />
                    ...
                    <p id='qus12'>
                        <b>#9 Painting can improve mental health</b><br />
                    ...
                    <p id='qus13'>
                        <b>#10 Painting can improve health in your older years</b><br />
